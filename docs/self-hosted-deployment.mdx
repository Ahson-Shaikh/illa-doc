...
[Easypanel](https://easypanel.io) is a self-hosted Docker deployment platform, and ILLA Builder has a one-click deployment template there: https://easypanel.io/templates/illa

[![Deploy on Easypanel](https://easypanel.io/img/deploy-on-easypanel-40.svg)](https://easypanel.io/templates/illa)

![ILLA Builder running in the Easypanel panel](/img/easypanel-panel.png)
